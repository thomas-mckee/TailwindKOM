...
export const SegmentCard = ({ segment }) => { 
    ...
    return (
        <a 
            ...
            className={`block bg-white rounded-lg shadow-md border-l-6 ${windScoreBorderClass} p-6 hover:shadow-lg transition-shadow cursor-pointer`}
        >
            <div className="flex items-start justify-between mb-4">
                ...
                <div className={`text-lg px-4 py-1 rounded-full font-semibold ${windScoreColourClass} flex-shrink-0`}>
            ...
            <div className='grid grid-cols-3 gap-4'>
                <div className='text-center p-3 bg-blue-50 rounded-lg'>
                    <Clock className='h-5 w-5 text-blue-600 mb-1 mx-auto'/>
                ...
                <div className='text-center p-3 bg-yellow-50 rounded-lg'>
                    <Trophy className='h-5 w-5 text-yellow-600 mb-1 mx-auto'/>
